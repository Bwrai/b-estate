    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          ...
          items-center rounded-full w-12 h-12 flex justify-center bg-slate-100 cursor-pointer"
          >
            <FaShare
          ...
          {/* flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'> */}
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-5 gap-1">
            ...
            <div className=" flex gap-2">
              <p className="bg-red-900 w-full max-w-[200px] text-white rounded-md text-center p-1">
